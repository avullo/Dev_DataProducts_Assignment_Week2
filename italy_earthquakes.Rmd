...
Data available at the [INGV page](http://info.terremoti.ingv.it/) is taken using the [INGV webservices](http://webservices.ingv.it) and downloaded as a text file a local file names.
...
File is a simple text with header and columns delimited by '|'.
